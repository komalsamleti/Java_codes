...
public class Test {
	...
	public static void main(String[] args) throws IOException {
		...
		String source, destination, carName = "", typeOfVehicle;
		int petrolCost = 80;
		int dieselCost = 60;
		...
		typeOfVehicle = vehicleMap.get(carName);
		if (typeOfVehicle.equals("Car") || typeOfVehicle.equals("Bus")) {
		...
		} else if (typeOfVehicle.equals("SUV")) {
